...
int main(int argc, char *argv[])
{
    ...
    Noise n(15641);
    Noise n2(0);
    Octave o(0.2,10000,6000,1000,0.05,w,w,n,n2);
    Octave o2(0.1,2500,50000,20,0.01,w,w,n2,n);
    Octave o3(0.05,1250,50000,5,0.005,w,w,n2,n);
    QVector<Octave> os;
    os.push_back(o);
    os.push_back(o2);
    TerrainOctaves t(os,a,b,1000);*/
    MeshBuilder bu;
    QString nom="terrain";
